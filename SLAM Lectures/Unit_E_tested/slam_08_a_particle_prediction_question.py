...
class ParticleFilter:
    ...
    def predict(self, control):
        ...
        #control_ = left_ ,right_
        for i in self.particles:
            left_ = random.gauss(left, left_segma)
            right_ = random.gauss(right, right_segma)
            new_particles.append(self.g(i,[left_,right_],self.robot_width))
            #print(i)self.g(i,control_,self.robot_width)
            #print("-->")
            #print(self.g(i,[left_,right_], self.robot_width))
