...
class Particle:
    ...
    def wl_likelihood_of_correspondence(self, measurement,
        ...
        #likelyhood = (1/(2*pi*sqrt(np.linalg.det(Q_l)))) *np.exp((-1/2)*delta_Q)
        return likelihood # Replace this.
    ...
    def initialize_new_landmark(self, measurement_in_scanner_system,
        ...
        scanner_pose = (self.pose[0] + cos(self.pose[2]) * scanner_displacement,
                        ...
                        self.pose[2])
        codinate = LegoLogfile.scanner_to_world(scanner_pose,measurement_in_scanner_system)
