...
class DrawableObject(object):
    ...
    def path_draw(self,at_step):
        print "Background draw." ,at_step
...
class Trajectory(DrawableObject):
    ...
    def path_draw(self,at_step):
        if (at_step - self.last_step) >  1:
            for step in range(at_step-self.last_step):
                 self.path(self.last_step+step)
        else :
            self.path(at_step)
        self.last_step = at_step

    def path(self,at_step):
        ...
        if p:
            ...
            self.p_xy_only.append(p[0:2])
            self.canvas.create_line(*self.p_xy_only, fill=self.background_color)
...
#..........................................................................
#..........................................................................
def get_data(data_pakage,robot):
    global canvas_extents, sensor_canvas_extents, world_extents, max_scanner_range
    ...
    # Insert: landmarks.
    draw_objects.append(Landmarks(robot.landmarks, world_canvas, canvas_extents, world_extents))
...
def run(index):
    print("fuck")
#.........................................................................
# Main program.CCSP SNPA
if __name__ == '__main__':

    # Construct logfile (will be read in load_data()).
    logfile = LegoLogfile()
    #...............................................
    #data_line  = Pyro4.Proxy("PYRONAME:example.navi")
    #...............................................
    #...............................................
    # Setup GUI stuff.
    root = Tk()
    ...
    sensor_canvas = Canvas(frame1,width=sensor_canvas_extents[0],height=sensor_canvas_extents[1],bg="black")
    ...
    frame2 = Frame(root)
    frame2.pack()
    load = Button(frame2,text="Refresh the connection ",command=add_file)
    load.pack(side=LEFT)
    ...
    all_file_names = []
    add_file()
    #ani = animation.FuncAnimation(frame1, slider_moved(50), interval=500)
    root.mainloop()
